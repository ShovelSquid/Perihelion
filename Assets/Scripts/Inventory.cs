...
public class Inventory : MonoBehaviour
{
    ...
    public void DropInventory()
    {
        ...
        foreach (GameObject item in items)
        {
            ...
            Instantiate(item, center + offset, rot);
    ...
    private Vector3 FindDropOffset(List<Vector3> existing)
    {
        ...
        {
            Vector3 candidate = UnityEngine.Random.insideUnitSphere * dropRadius;
            bool tooClose = false;
        ...
        return UnityEngine.Random.insideUnitSphere * dropRadius;
    }
